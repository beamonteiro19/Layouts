...
public class Quiz extends AppCompatActivity {
    ...
    private void setQuestionScreen(int currentQuestions) {
        ...
        questionImage.setImageResource(questionsItems.get(currentQuestions).getImageResId());
    ...
    private void loadAllQuestions() {
        ...
        try {
            ...
            for (int i = 0; i < questions.length(); i++) {
                ...
                int imageResId = getResources().getIdentifier(question.getString("image"), "drawable", getPackageName());

                questionsItems.add(new QuestionsItems(questionsString, answer1String, answer2String, answer3String, answer4String, correctString, imageResId));
            }
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(Quiz.this);
        materialAlertDialogBuilder.setTitle(R.string.app_name);
        materialAlertDialogBuilder.setMessage("Tem certeza que deseja sair do Quiz em andamento?");
